...
#define UE_PROJECT_NAME ThirstToLive
#define UE_TARGET_NAME ThirstToLiveEditor
...
#define INCLUDE_CHAOS                                                          \
  UE_DEPRECATED_MACRO(                                                         \
      5.1, "INCLUDE_CHAOS is deprecated and should always be considered 1.")   \
  1
#define WITH_CHAOS                                                             \
  UE_DEPRECATED_MACRO(                                                         \
      5.1, "WITH_CHAOS is deprecated and should always be considered 1.")      \
  1
#define WITH_CHAOS_CLOTHING                                                    \
  UE_DEPRECATED_MACRO(                                                         \
      5.1,                                                                     \
      "WITH_CHAOS_CLOTHING is deprecated and should always be considered 1.")  \
  1
#define WITH_CHAOS_NEEDS_TO_BE_FIXED                                           \
  UE_DEPRECATED_MACRO(5.1, "WITH_CHAOS_NEEDS_TO_BE_FIXED is deprecated and "   \
                           "should always be considered 1.")                   \
  1
#define WITH_PHYSX                                                             \
  UE_DEPRECATED_MACRO(                                                         \
      5.1, "WITH_PHYSX is deprecated and should always be considered 1.")      \
  1
#define WITH_PHYSX_COOKING                                                     \
  UE_DEPRECATED_MACRO(                                                         \
      5.1,                                                                     \
      "WITH_PHYSX_COOKING is deprecated and should always be considered 0.")   \
  0
#define PHYSICS_INTERFACE_PHYSX                                                \
  UE_DEPRECATED_MACRO(5.1, "PHYSICS_INTERFACE_PHYSX is deprecated and should " \
                           "always be considered 0.")                          \
  0
#define WITH_APEX                                                              \
  UE_DEPRECATED_MACRO(                                                         \
      5.1, "WITH_APEX is deprecated and should always be considered 0.")       \
  0
#define WITH_APEX_CLOTHING                                                     \
  UE_DEPRECATED_MACRO(                                                         \
      5.1,                                                                     \
      "WITH_APEX_CLOTHING is deprecated and should always be considered 0.")   \
  0
#define WITH_NVCLOTH                                                           \
  UE_DEPRECATED_MACRO(                                                         \
      5.1, "WITH_NVCLOTH is deprecated and should always be considered 0.")    \
  0
#define WITH_IMMEDIATE_PHYSX                                                   \
  UE_DEPRECATED_MACRO(                                                         \
      5.1,                                                                     \
      "WITH_IMMEDIATE_PHYSX is deprecated and should always be considered 0.") \
  0
#define WITH_CUSTOM_SQ_STRUCTURE                                               \
  UE_DEPRECATED_MACRO(5.1, "WITH_CUSTOM_SQ_STRUCTURE is deprecated and "       \
                           "should always be considered 0.")                   \
  0
