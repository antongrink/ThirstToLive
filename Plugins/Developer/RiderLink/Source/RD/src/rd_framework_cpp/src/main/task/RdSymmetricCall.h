...
class RdSymmetricCall : public RdCall<TReq, TRes, ReqSer, ResSer>,
                        public RdEndpoint<TReq, TRes, ReqSer, ResSer> {
public:
  ...
  friend bool operator==(const RdSymmetricCall &lhs,
                         const RdSymmetricCall &rhs) {
    return &lhs == &rhs;
  }
