...
namespace rd {
//	SerializationCtx::SerializationCtx(const IProtocol &protocol) :
//serializers(protocol.serializers.get()) {}

//	SerializationCtx::SerializationCtx(const Serializers *const serializers)
