...
inline std::string to_string(std::string const &val) { return val; }
...
template <typename T> inline std::string to_string(T const *val) {
...
template <typename T> inline std::string to_string(optional<T> const &val) {
  if (val.has_value()) {
...
template <class T> std::string as_string(T const &t) { return to_string(t); }
...
template <class T> std::wstring as_wstring(T const &t) { return to_wstring(t); }
} // namespace detail
...
template <typename T> std::wstring to_wstring(T const &val) {
