...
void RdEditorRoot::RdEditorRootSerializersOwner::registerSerializersCore(
    rd::Serializers const &serializers) const {
  RdEditorModel::serializersOwner.registry(serializers);
}

void RdEditorRoot::connect(rd::Lifetime lifetime,
...
// constants
// initializer
void RdEditorRoot::initialize() { serializationHash = -441687577021743677L; }
// primary ctor
// secondary constructor
// default ctors and dtors
RdEditorRoot::RdEditorRoot() { initialize(); }
// reader
// writer
// virtual init
...
// identify
void RdEditorRoot::identify(const rd::Identities &identities,
...
// external to string
std::string to_string(const RdEditorRoot &value) { return value.toString(); }
} // namespace EditorPlugin
} // namespace JetBrains
