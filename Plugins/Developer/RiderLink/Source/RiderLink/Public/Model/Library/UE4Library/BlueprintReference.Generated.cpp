...
BlueprintReference::BlueprintReference(FString pathName_)
    : rd::IPolymorphicSerializable(), pathName_(std::move(pathName_)) {
  initialize();
}
// secondary constructor
// default ctors and dtors
// reader
BlueprintReference BlueprintReference::read(rd::SerializationCtx &ctx,
                                            rd::Buffer &buffer) {
...
// writer
void BlueprintReference::write(rd::SerializationCtx &ctx,
                               rd::Buffer &buffer) const {
  rd::Polymorphic<std::decay_t<decltype(pathName_)>>::write(ctx, buffer,
                                                            pathName_);
}
// virtual init
// identify
// getters
FString const &BlueprintReference::get_pathName() const { return pathName_; }
// intern
// equals trait
bool BlueprintReference::equals(rd::ISerializable const &object) const {
  ...
  if (this == &other)
    return true;
  if (this->pathName_ != other.pathName_)
    return false;
