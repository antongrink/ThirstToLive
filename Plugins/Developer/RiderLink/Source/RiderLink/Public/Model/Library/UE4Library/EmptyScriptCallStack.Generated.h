...
public:
  ...
  static constexpr rd::wstring_view message{
      L"Script call stack: [Empty] (FFrame::GetStackTrace() called from native "
      L"code)",
      76};
...
public:
  ...
  // reader
  static EmptyScriptCallStack read(rd::SerializationCtx &ctx,
                                   rd::Buffer &buffer);
...
public:
  // equality operators
  friend bool operator==(const EmptyScriptCallStack &lhs,
                         const EmptyScriptCallStack &rhs);
  friend bool operator!=(const EmptyScriptCallStack &lhs,
                         const EmptyScriptCallStack &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::EmptyScriptCallStack> {
  size_t operator()(const JetBrains::EditorPlugin::EmptyScriptCallStack &value)
      const noexcept {
