...
UnableToDisplayScriptCallStack::read(rd::SerializationCtx &ctx,
                                     rd::Buffer &buffer) {
  UnableToDisplayScriptCallStack res{};
  return res;
}
// writer
void UnableToDisplayScriptCallStack::write(rd::SerializationCtx &ctx,
...
// intern
// equals trait
bool UnableToDisplayScriptCallStack::equals(
    rd::ISerializable const &object) const {
  auto const &other =
      dynamic_cast<UnableToDisplayScriptCallStack const &>(object);
  if (this == &other)
    return true;
...
// equality operators
bool operator==(const UnableToDisplayScriptCallStack &lhs,
