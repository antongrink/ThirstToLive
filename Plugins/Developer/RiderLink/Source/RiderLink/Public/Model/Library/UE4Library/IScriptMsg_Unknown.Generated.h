...
class RIDERLINK_API IScriptMsg_Unknown : public IScriptMsg,
...
public:
  // equality operators
  friend bool operator==(const IScriptMsg_Unknown &lhs,
                         const IScriptMsg_Unknown &rhs);
  friend bool operator!=(const IScriptMsg_Unknown &lhs,
                         const IScriptMsg_Unknown &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::IScriptMsg_Unknown> {
  size_t operator()(
      const JetBrains::EditorPlugin::IScriptMsg_Unknown &value) const noexcept {
