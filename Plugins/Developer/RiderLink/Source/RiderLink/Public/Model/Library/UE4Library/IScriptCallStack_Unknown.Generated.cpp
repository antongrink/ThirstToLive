...
IScriptCallStack_Unknown::IScriptCallStack_Unknown(
    rd::RdId unknownId_, rd::Buffer::ByteArray unknownBytes_)
...
IScriptCallStack_Unknown::IScriptCallStack_Unknown() { initialize(); }
// reader
IScriptCallStack_Unknown
IScriptCallStack_Unknown::read(rd::SerializationCtx &ctx, rd::Buffer &buffer) {
  throw std::logic_error("Unknown instances should not be read via serializer");
}
// writer
void IScriptCallStack_Unknown::write(rd::SerializationCtx &ctx,
...
// equality operators
bool operator==(const IScriptCallStack_Unknown &lhs,
