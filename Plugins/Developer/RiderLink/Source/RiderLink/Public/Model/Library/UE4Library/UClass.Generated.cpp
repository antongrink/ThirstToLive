...
// identify
// getters
FString const &UClass::get_name() const { return name_; }
// intern
// equals trait
...
bool operator!=(const UClass &lhs, const UClass &rhs) { return !(lhs == rhs); }
// hash code trait
...
// type name trait
std::string UClass::type_name() const { return "UClass"; }
// static type name trait
std::string UClass::static_type_name() { return "UClass"; }
...
// external to string
std::string to_string(const UClass &value) { return value.toString(); }
} // namespace EditorPlugin
} // namespace JetBrains
