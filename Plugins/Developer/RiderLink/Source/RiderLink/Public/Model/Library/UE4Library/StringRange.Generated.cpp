...
StringRange::StringRange(int32_t first_, int32_t last_)
    : rd::IPolymorphicSerializable(), first_(std::move(first_)),
...
// identify
// getters
int32_t const &StringRange::get_first() const { return first_; }
int32_t const &StringRange::get_last() const { return last_; }
// intern
// equals trait
...
// type name trait
std::string StringRange::type_name() const { return "StringRange"; }
// static type name trait
std::string StringRange::static_type_name() { return "StringRange"; }
...
// external to string
std::string to_string(const StringRange &value) { return value.toString(); }
} // namespace EditorPlugin
} // namespace JetBrains
