...
public:
  // equality operators
  friend bool operator==(const ScriptCallStack &lhs,
                         const ScriptCallStack &rhs);
  friend bool operator!=(const ScriptCallStack &lhs,
                         const ScriptCallStack &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::ScriptCallStack> {
  size_t operator()(
      const JetBrains::EditorPlugin::ScriptCallStack &value) const noexcept {
