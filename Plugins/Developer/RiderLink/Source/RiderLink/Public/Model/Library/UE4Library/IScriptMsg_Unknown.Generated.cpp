...
// primary ctor
IScriptMsg_Unknown::IScriptMsg_Unknown(rd::RdId unknownId_,
...
IScriptMsg_Unknown::IScriptMsg_Unknown() { initialize(); }
// reader
IScriptMsg_Unknown IScriptMsg_Unknown::read(rd::SerializationCtx &ctx,
                                            rd::Buffer &buffer) {
  throw std::logic_error("Unknown instances should not be read via serializer");
}
// writer
void IScriptMsg_Unknown::write(rd::SerializationCtx &ctx,
