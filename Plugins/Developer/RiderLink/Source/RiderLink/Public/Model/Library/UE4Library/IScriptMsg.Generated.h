...
public:
  ...
  // reader
  static rd::Wrapper<IScriptMsg> readUnknownInstance(rd::SerializationCtx &ctx,
                                                     rd::Buffer &buffer,
                                                     rd::RdId const &unknownId,
                                                     int32_t size);
...
template <> struct hash<JetBrains::EditorPlugin::IScriptMsg> {
  size_t
  operator()(const JetBrains::EditorPlugin::IScriptMsg &value) const noexcept {
