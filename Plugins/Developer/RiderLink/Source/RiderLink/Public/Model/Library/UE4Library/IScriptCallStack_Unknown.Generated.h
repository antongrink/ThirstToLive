...
class RIDERLINK_API IScriptCallStack_Unknown : public IScriptCallStack,
...
public:
  // primary ctor
  IScriptCallStack_Unknown(rd::RdId unknownId_,
                           rd::Buffer::ByteArray unknownBytes_);
  ...
  IScriptCallStack_Unknown &
  operator=(IScriptCallStack_Unknown const &) = default;
  ...
  // reader
  static IScriptCallStack_Unknown read(rd::SerializationCtx &ctx,
                                       rd::Buffer &buffer);
...
public:
  // equality operators
  friend bool operator==(const IScriptCallStack_Unknown &lhs,
                         const IScriptCallStack_Unknown &rhs);
  friend bool operator!=(const IScriptCallStack_Unknown &lhs,
                         const IScriptCallStack_Unknown &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::IScriptCallStack_Unknown> {
  size_t operator()(const JetBrains::EditorPlugin::IScriptCallStack_Unknown
