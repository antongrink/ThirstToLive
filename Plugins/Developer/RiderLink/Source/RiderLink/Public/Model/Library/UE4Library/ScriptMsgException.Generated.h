...
public:
  // equality operators
  friend bool operator==(const ScriptMsgException &lhs,
                         const ScriptMsgException &rhs);
  friend bool operator!=(const ScriptMsgException &lhs,
                         const ScriptMsgException &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::ScriptMsgException> {
  size_t operator()(
      const JetBrains::EditorPlugin::ScriptMsgException &value) const noexcept {
