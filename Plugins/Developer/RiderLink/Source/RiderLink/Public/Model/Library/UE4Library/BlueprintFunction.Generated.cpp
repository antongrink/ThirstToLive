...
BlueprintFunction::BlueprintFunction(rd::Wrapper<UClass> class_, FString name_)
    : rd::IPolymorphicSerializable(), class_(std::move(class_)),
...
// reader
BlueprintFunction BlueprintFunction::read(rd::SerializationCtx &ctx,
                                          rd::Buffer &buffer) {
...
// writer
void BlueprintFunction::write(rd::SerializationCtx &ctx,
...
// identify
// getters
UClass const &BlueprintFunction::get_class() const { return *class_; }
FString const &BlueprintFunction::get_name() const { return name_; }
// intern
// equals trait
...
// type name trait
std::string BlueprintFunction::type_name() const { return "BlueprintFunction"; }
