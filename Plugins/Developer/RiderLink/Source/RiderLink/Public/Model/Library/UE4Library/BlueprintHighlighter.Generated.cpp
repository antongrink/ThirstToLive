...
BlueprintHighlighter::BlueprintHighlighter(int32_t begin_, int32_t end_)
    : rd::IPolymorphicSerializable(), begin_(std::move(begin_)),
      end_(std::move(end_)) {
  initialize();
}
...
// reader
BlueprintHighlighter BlueprintHighlighter::read(rd::SerializationCtx &ctx,
                                                rd::Buffer &buffer) {
...
// writer
void BlueprintHighlighter::write(rd::SerializationCtx &ctx,
...
// identify
// getters
int32_t const &BlueprintHighlighter::get_begin() const { return begin_; }
int32_t const &BlueprintHighlighter::get_end() const { return end_; }
// intern
// equals trait
...
// equality operators
bool operator==(const BlueprintHighlighter &lhs,
