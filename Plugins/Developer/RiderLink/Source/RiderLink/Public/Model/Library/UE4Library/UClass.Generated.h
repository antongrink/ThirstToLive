...
template <> struct hash<JetBrains::EditorPlugin::UClass> {
  size_t
  operator()(const JetBrains::EditorPlugin::UClass &value) const noexcept {
...
template <>
class tuple_size<JetBrains::EditorPlugin::UClass>
    : public integral_constant<size_t, 1> {};

template <size_t I> class tuple_element<I, JetBrains::EditorPlugin::UClass> {
public:
