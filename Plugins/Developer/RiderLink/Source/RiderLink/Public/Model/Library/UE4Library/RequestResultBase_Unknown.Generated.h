...
class RIDERLINK_API RequestResultBase_Unknown : public RequestResultBase,
                                                public rd::IUnknownInstance {
...
public:
  // primary ctor
  RequestResultBase_Unknown(int32_t requestID_, rd::RdId unknownId_,
                            rd::Buffer::ByteArray unknownBytes_);
  ...
  RequestResultBase_Unknown &
  operator=(RequestResultBase_Unknown const &) = default;
  ...
  // reader
  static RequestResultBase_Unknown read(rd::SerializationCtx &ctx,
                                        rd::Buffer &buffer);
...
public:
  // equality operators
  friend bool operator==(const RequestResultBase_Unknown &lhs,
                         const RequestResultBase_Unknown &rhs);
  friend bool operator!=(const RequestResultBase_Unknown &lhs,
                         const RequestResultBase_Unknown &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::RequestResultBase_Unknown> {
  size_t operator()(const JetBrains::EditorPlugin::RequestResultBase_Unknown
