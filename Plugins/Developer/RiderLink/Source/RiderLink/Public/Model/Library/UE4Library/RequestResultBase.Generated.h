...
public:
  ...
  // reader
  static rd::Wrapper<RequestResultBase>
...
public:
  // equality operators
  friend bool operator==(const RequestResultBase &lhs,
                         const RequestResultBase &rhs);
  friend bool operator!=(const RequestResultBase &lhs,
                         const RequestResultBase &rhs);
  // hash code trait
...
template <> struct hash<JetBrains::EditorPlugin::RequestResultBase> {
  size_t operator()(
      const JetBrains::EditorPlugin::RequestResultBase &value) const noexcept {
