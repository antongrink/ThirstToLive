...
EmptyScriptCallStack::EmptyScriptCallStack() { initialize(); }
// reader
EmptyScriptCallStack EmptyScriptCallStack::read(rd::SerializationCtx &ctx,
                                                rd::Buffer &buffer) {
  EmptyScriptCallStack res{};
  return res;
}
// writer
void EmptyScriptCallStack::write(rd::SerializationCtx &ctx,
...
// equality operators
bool operator==(const EmptyScriptCallStack &lhs,
