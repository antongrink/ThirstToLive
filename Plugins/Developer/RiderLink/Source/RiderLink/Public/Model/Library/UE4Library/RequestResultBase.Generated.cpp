...
RequestResultBase::RequestResultBase(int32_t requestID_)
    : rd::IPolymorphicSerializable(), requestID_(std::move(requestID_)) {
  initialize();
}
// secondary constructor
// default ctors and dtors
// reader
rd::Wrapper<RequestResultBase> RequestResultBase::readUnknownInstance(
    rd::SerializationCtx &ctx, rd::Buffer &buffer, rd::RdId const &unknownId,
    int32_t size) {
  int32_t objectStartPosition = buffer.get_position();
  auto requestID_ = buffer.read_integral<int32_t>();
  auto unknownBytes =
      rd::Buffer::ByteArray(objectStartPosition + size - buffer.get_position());
...
// identify
// getters
int32_t const &RequestResultBase::get_requestID() const { return requestID_; }
// intern
// equals trait
// equality operators
...
// type name trait
std::string RequestResultBase::type_name() const { return "RequestResultBase"; }
